...
import { SvgKakao, SvgGoogle, SvgFacebook, SvgTweeter, SvgApple, SvgLine } from "../img/login/svg_login"
    ...
    <StyleLogin>
      ...
      <div className="box-login">
        <div className="box-login-top">
          ...
          <button type="click" onClick={login} ref={submitBtn} className="btn">로그인</button>
        </div>
        <DivideLine />
        <div className="box-login-bottom">
          ...
          <ul className="login-social"> 
            <li className="social-link">
              <button><SvgKakao/></button>
            </li>
            <li className="social-link">
              <button><SvgGoogle/></button>
            </li>
            <li className="social-link">
              <button><SvgFacebook/></button>
            </li>
            <li className="social-link">
              <button><SvgTweeter/></button>
            </li>
            <li className="social-link">
              <button><SvgApple/></button>
            </li>
            <li className="social-link">
              <button><SvgLine/></button>
            </li>
          </ul>
        </div>
      </div>
