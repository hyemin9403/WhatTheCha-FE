        ...
        <StyleCard className='on-enter'>
            <div className='card-movie'>
                <div className='card-content'>
                    <button className='btn-off'><SvgCancel/></button>
                    <CardBackgorund>
                                ...
                                <CardInfo>
                                    ...
                                    <CardBtnGroup>
                                        ...
                                        <button className='btn-with'>
                                            <div className='btn-svg'><SvgWith/></div>
                                            <div className='btn-deco'><SvgBeta/></div>
                                            <span>같이보기</span>
                                        </button>
                ...
                <CardMenu>
                    <li className='active' onClick={changeBasic}>기본정보</li>
...
const CardBackgorund = styled.div`
    ...
    .back-deco-side{
        ...
        top: 0px;
        left: 0px;
        background-image: linear-gradient(to right, rgb(0, 0, 0) 3%, rgba(0, 0, 0, 0.7) 26%, rgba(0, 0, 0, 0.45) 50%, rgba(0, 0, 0, 0.2) 75%, rgba(0, 0, 0, 0) 100%);
        width: 45.6852%;
        height: 100%;
    }
    .back-deco-img{
...
const CardMenu = styled.ul`
    ...
    li.active{
        ...
        display: inline-block;
        border-color: rgba(255, 255, 255, 0.7) rgba(255, 255, 255, 0.7) rgb(255, 255, 255);
        border-bottom-width: 4px;
        border-bottom-style: solid;
        font-size: 1.25vw;
        font-weight: 700;
