                ...
                <CardInfo>
                  ...
                  <ul className="card-info-ul">
                    <li>
                      ...
                      <span className="card-info-director">{d?.director}</span>
                    </li>
                    <li>
                  ...
                  <CardBtnGroup>
                    <button onClick={() => history.push({pathname:`/video`, state: (d.youtubeId ? d.youtubeId : "")})} className="btn-play">
                      <SvgPlay />
                      <span>재생</span>
                    </button>
                ...
                <CardDetail>
                  ...
                  <div className="detail-right">
                    <div className="detail-star">
                      ...
                      <span className="detail-star-score">{d.average_star}</span>
                      <span className="detail-star-people">{d.numberOfStarRated}</span>
                    </div>
                    <Comment>
                      <div className="comment-row">
                        <div className="comment-card">
                          ...
                          <div className="comment-like">
                            <svg className="SVGInline-svg css-1ox7qbr-svg" width="36px" height="36px" viewBox="0 0 36 36" version="1.1">
                              <g id="Icons_Like" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                  <g id="thumbs" transform="translate(0.000000, -1.000000)" fill="#d1d1d1" fillRule="nonzero">
                                      <path d="M8,34 L8,12 C8,12 10.096,11.977 10,12 C9.949,12.012 17,10.209 17,1 C17,0.988 19.987,1 20,1 L22,1 C25.742,2.006 26,6 26,6 L26,12 L36,12 L36,22 C36,33.592 25,34 25,34 L8,34 Z M22,16 L22,7 C22,5.271 20,5 20,5 C20,13.717 12,16 12,16 L12,30 L25,30 C31.935,30 32,23 32,23 L32,16 L22,16 Z M0,12 L4,12 L4,37 L0,37 L0,12 L0,12 Z" id="Shape"></path>
                                  </g>
                              </g>
                            </svg>
                            <span>685</span>
                        ...
                        <div className="comment-card">
                          <div className="comment-name">권오연</div>
                          <div className="comment-text">같은 후기 다른 느낌 위플래쉬: 이 영화는 미쳤다..ㄷㄷ 킹스맨: 이 영화는 미쳤다ㅋㅋㅋ 매드맥스: 이!!! 영화는!!.</div>
                          <div className="comment-like">
                            <svg className="SVGInline-svg css-1ox7qbr-svg" width="36px" height="36px" viewBox="0 0 36 36" version="1.1">
                              <g id="Icons_Like" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                  <g id="thumbs" transform="translate(0.000000, -1.000000)" fill="#d1d1d1" fillRule="nonzero">
                      ...
                      <div className="comment-row">
                        <div className="comment-card">
                          <div className="comment-name">권오연</div>
                          <div className="comment-text">노장 감독의 페미니즘을 말하는 미친영화. 우린 누군가에게 소유물이 아니며 주체로서 행동하는 한 "인간" 임을 잊지 말길.</div>
                          <div className="comment-like">
                            <svg className="SVGInline-svg css-1ox7qbr-svg" width="36px" height="36px" viewBox="0 0 36 36" version="1.1">
                              <g id="Icons_Like" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                  <g id="thumbs" transform="translate(0.000000, -1.000000)" fill="#d1d1d1" fillRule="nonzero">
                        ...
                        <div className="comment-card">
                          <div className="comment-name">권오연</div>
                          <div className="comment-text">할아버지 감독이 여성 캐릭터를 다루는 방식이 놀랍다. 내가 차이나타운에 기대했던 게 이런거라고.</div>
                          <div className="comment-like">
                            <svg className="SVGInline-svg css-1ox7qbr-svg" width="36px" height="36px" viewBox="0 0 36 36" version="1.1">
                              <g id="Icons_Like" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                  <g id="thumbs" transform="translate(0.000000, -1.000000)" fill="#d1d1d1" fillRule="nonzero">
